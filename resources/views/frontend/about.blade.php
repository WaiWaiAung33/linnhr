                ...
                <div class="col-md-6">
                    <div class="text-white">
                        ...
                        <ul class="page-next d-inline-block mb-0">
                            <li><a href="{{route('frontend.home')}}" class="text-uppercase font-weight-bold">Home</a></li>
   ...
   <div style="background-color: #0d4091">
    ...
    <div style="margin:30px;">
        ...
        <p style="text-align: justify;">
            ...
            ကျွန်တော်များ Linn IT Solution Co.,Ltd သည်ဝန်ကြီးဌာနများမှလိုအပ်သည်များကို ပိုမိုလျင်မြန်စွာ ဝန်အောင်မှုပေးနိုင်ရန်အတွက် ၂၀၀၈ ခုနှစ်တွင် အမှတ် (၁၁၇) ၊ သပြေကုန်းရပ်ကွက်၊ နေပြည်တော်တွင် Linn IT Solution Center – 2 (သပြေကုန်း) အားဖွင့်လှစ်ခဲ့ပြီး ဝန်ဆောင်မှု များပေးခဲ့ပါသည်။
            ၂၀၁၀ ခုနှစ်တွင် Linn IT Solution Co.,Ltd. အဖြစ် စတင်ပြောင်းလဲဖွဲ့စည်းခဲ့ပြီး ပျဉ်းမနား နှင့် နေပြည်တော် ဆိုင်ခွဲများအား Linn IT & Mobile Shop အဖြစ်ပြောင်းလဲ ကာ Mobile Phone နှင့်ပါတ်သက်သော ပစ္စည်းများ ရောင်းချခဲ့ ပါသည်။

            Linn IT Solution Co., Ltd. သည် နေပြည်တော် ကောင်စီနယ်မြေရှိ ပျဉ်းမနားတွင် Linn IT & Mobile Mart အဖြစ် ၂၀၁၅ ခုနှစ်၊ ဧပြီလ (၅) ရက်နေ့တွင် အောင်မြင်စွာ ဖွင့်လှစ်နိုင် ခဲ့ပါသည်။

            USA, Japan, China နှင့် Taiwan နိုင်ငံများမှ အရေအသွေးမြင့် ပစ္စည်းများအား တင်သွင်းပြီး ပစ္စည်းမှန် စျေးနှုန်းမှန်ဖြင့် ရောင်းချ ပေးလျက်ရှိသလို လိုအပ်သော ဝန်ဆောင်မှု အားလုံးကိုလည်း အချိန်နှင့် တပြေးညီ ဆောင်ရွက်လျက် ရှိပါသည်။ ဝန်ကြီးဌာနများ၊ စစ်ရုံးများမှ ခေါ်ယူခဲ့သော တင်ဒါများတွင် ဝင်ရောက် ယှဉ်ပြိုင်ခဲ့ပြီး လိုအပ်သော ပစ္စည်းများကိုလည်း တင်သွင်းပေးနိုင်ခဲ့ပါသည်။
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <p class="text-white mb-4 footer-list-title" style="font-size: 15px">Branch</p>
                      <ul class="social list-inline mb-0">
                                ...
                                <li><a href="#" style="color: white;font-size: 13px" class="unicode" >Linn Naypyitaw Branch</a></li>
                                <li><a href="#" style="color: white;font-size: 13px" class="unicode" >Linn Pyinmana Branch</a></li>
                            ...
                            <li class="list-inline-item"><a href="#" class="rounded" style="font-size: 13px"><i class="mdi mdi-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="#" class="rounded" style="font-size: 13px"><i class="mdi mdi-instagram"></i></a></li>
                            <li class="list-inline-item"><a href="#" class="rounded" style="font-size: 13px"><i class="mdi mdi-google"></i></a></li>
                        </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <p class="text-white mb-4 footer-list-title" style="font-size: 15px">Phone No</p>
                    <ul class="list-unstyled footer-list">
                        <li><a href="#" style="color: white;font-size: 13px" class="unicode">09-789799799, 067-22884,23884,24884</a></li>
                        <li><a href="#" style="color: white;font-size: 13px" class="unicode" >067-414884,414885,432884</a></li>
                         <li><a href="#" style="color: white;font-size: 13px" class="unicode">09-422294884, 09-346038884, 09-400558855</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <ul class="list-unstyled text-foot mt-4 mb-0">
                         <li><a href="#" style="color: white;font-size: 13px" class="unicode">No. 14/585, 4th Street, Paung Laung Quarter, Pyinmana.</a></li>
                        <li><a href="#" style="color: white;font-size: 13px" class="unicode">No.117, Thapyagone Quarter, Naypyitaw </a></li>
                        <li><a href="#" style="color: white;font-size: 13px" class="unicode">No.11/7, Bogyoke Road, Pyinmana</a></li>
    ...
    <footer class="footer footer-bar">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="">
                        <p style="font-size: 13px" class="mb-0">© 2020 -2021 Job. Design with <i class="mdi mdi-heart text-danger"></i> by Linn.</p>
                    </div>
                </div>
            </div>
        </div><!--end container-->
